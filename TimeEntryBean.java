...
public class TimeEntryBean {
	...
	public String toString() {
		return "TimeEntryBean [tDate=" + tDate + ", tPunchIn=" + tPunchIn + ", tPunchInHour=" + tPunchInHour
				+ ", tPunchOut=" + tPunchOut + ", tPunchOutHour=" + tPunchOutHour + ", tBreak=" + tBreak
				+ ", tDuration=" + tDuration + ", tCDate=" + tCDate + ", tDayInNumber=" + tDayInNumber + ", tDayIntext="
				+ tDayIntext + ", tOtHours=" + tOtHours + ", tStatus=" + tStatus + ", tShift=" + tShift
				+ ", tNormalDate=" + tNormalDate + ", tmonthYear=" + tmonthYear + ", tId=" + tId
				+ ", tPresentDaysCount=" + tPresentDaysCount + ", lOtHours=" + lOtHours + ", lOtMinutes=" + lOtMinutes
				+ "]";
	}
